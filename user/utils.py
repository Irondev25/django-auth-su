...
#this function accepts only bytes object and encode it from base10
#base64
...
#This mixin will be used in forms to have them the functionality
#sending email
#This mixin send an account activation email
#In the event of error mail_validation_error is provided to show the output
