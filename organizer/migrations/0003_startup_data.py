# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-06-18 14:14
...
def add_startup_data(app, schema_editor):
    Startup = app.get_model('organizer','Startup')
...
def remove_startup_data(app, schema_editor):
    Startup = app.get_model('organizer','Startup')
    for startup in STARTUPS:
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('organizer', '0002_auto_20180618_1926'),
    ]
